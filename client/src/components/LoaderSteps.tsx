...
const steps = [
  ...
  { icon: TriangleIcon, label: "Assembling UI elements..." },
...
const Icon = steps[current].icon
  ...
  return (
    <div className="relative w-full h-full flex flex-col items-center justify-center bg-gray-950 overflow-hidden text-white">
      ...
      <p
        key={current}
        className="mt-8 text-lg font-light text-white/90 tracking-wide transition-all duration-700 easy-in-out opacity-100"
      >
        {steps[current].label}
      </p>
