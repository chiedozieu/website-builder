    ...
    <section className="flex flex-col items-center text-white text-sm pb-20 px-4 font-poppins">
      ...
      >
        <textarea
          ...
          required
        />
        <button className="ml-auto flex items-center gap-2 bg-linear-to-r from-[#CB52D4] to-indigo-600 rounded-md px-4 py-2 hover:scale-[1.02] active:scale-95 transition-all">
          {!loading ? (
            "Create with AI"
          ) : (
            <>
